...
class clasif():
    ...
    def winloop(self):
        ...
        frm1.pack()
        # Canvas
        canvas = tk.Canvas(frm1, width = 1800, height = 1200, bg='#5AFF00', bd=0, highlightthickness=0)       
        ...
        o=clasif()
        clasif.in_file=tk.Button(self,text='SELECT',font=(5),width=(15),command=o.in_f)
        ...
        clasif.loreg=tk.Button(self,text='Logistic Regression',font=(10),width=(25),command=o.log_reg)
        ...
        clasif.dtre=tk.Button(self,text='Decision Tree',font=(10),width=(25),command=o.d_tre)
        ...
        clasif.knn_bt=tk.Button(self,text='K-Nearest Neighbors',font=(10),width=(25),command=o.k_nn)
        ...
        clasif.lda=tk.Button(self,text='Linear Discriminant Analysis',font=(10),width=(25),command=o.l_da)
        ...
        clasif.gnb=tk.Button(self,text='Gaussian Naive Bayes',font=(10),width=(25),command=o.g_nb)
        ...
        clasif.svm=tk.Button(self,text='Support Vector Machine',font=(10),width=(25),command=o.s_vm)
        ...
        clasif.prd=tk.Button(self,text='Pred',font=(10),width=(10),command=o.prd)
